...
export const IMAGE_SOURCES = {
  ...
  'place:meghalaya/east-khasi/root-bridge': 'file:Living root bridge of Mawllinnong, East Khasi Hills.jpg',
  'place:ladakh/leh/pangong': 'file:Lake Pangong (Pangong Tso) in Ladakh.jpg',
  ...
  'place:assam/kamrup-metropolitan/kamakhya-temple': 'file:Kamakhya Temple, Nilachal Hills, Guwahati.JPG',
  'place:bihar/gaya/mahabodhi-temple': 'file:Mahabodhitemple.jpg',
  'place:chhattisgarh/kabirdham/bhoramdeo-temple': 'Bhoramdeo Temple',
  'place:gujarat/patan/rani-ki-vav': 'file:Rani ki vav 10.jpg',
  'place:haryana/kurukshetra/brahma-sarovar': 'file:Brahma Sarovar, Kurukshetra.jpg',
  ...
  'place:maharashtra/aurangabad/ajanta-caves': 'file:Ajanta caves.jpg',
  'place:manipur/imphal-west/kangla-fort': 'Kangla Fort',
  'place:mizoram/mamit/reiek-heritage-village': 'Reiek',
  'place:nagaland/kohima/khonoma-village': 'file:A view of Khonoma village, Nagaland, India.jpg',
  'place:odisha/puri/konark-sun-temple': 'file:Sun Temple Main Structure, Konark, Orissa.jpg',
  'place:punjab/amritsar/golden-temple': 'file:Golden Temple, Amritsar 01.jpg',
  ...
  'place:andaman-nicobar/south-andaman/cellular-jail': 'file:Cellular jail Andaman 17.jpg',
  'place:chandigarh/chandigarh-district/rock-garden': 'Rock Garden, Chandigarh',
  'place:dnh-daman-diu/diu/diu-fort': 'Diu Fort',
  'place:delhi/central-delhi/red-fort': 'file:Lahori Gate, Red Fort, Delhi - Lit up at night.jpg',
  'place:jammu-kashmir/srinagar/shalimar-bagh': 'Shalimar Bagh, Srinagar',
  'place:lakshadweep/lakshadweep-district/agatti-island': 'file:Anthan Beach in Agatti.jpg',
  'place:puducherry/puducherry-district/french-quarter': ['Aayi Mandapam', 'French Institute of Pondicherry'],
};

/**
 * For `file:`-pinned entries there is no article lookup, so map the entity back
 * to the Wikipedia article it belongs to for the "read more" attribution link.
 */
export const ARTICLE_FOR_PIN = {
  ...
  'place:lakshadweep/lakshadweep-district/agatti-island': 'Agatti Island',
};
