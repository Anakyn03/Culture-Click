  ...
  return (
    <div>
      <div className="px-[clamp(18px,4vw,48px)] pb-1.5 pt-8">
        <h2 className="font-serif text-[1.5rem] text-indigo dark:text-sand">Festival calendar</h2>
      ...
      <div className="grid gap-[18px] px-[clamp(18px,4vw,48px)] pb-[50px]" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(230px,1fr))' }}>
        {MONTHS.map((m) => (
          <div key={m} className={`min-h-[110px] rounded-2xl bg-sand p-[18px] ${byMonth[m].length ? '' : 'opacity-40'}`}>
