  ...
  return (
    <header className="sticky top-0 z-[60] flex items-center justify-between border-b border-black/10 bg-ivory/90 px-[clamp(18px,4vw,48px)] py-4 backdrop-blur-md dark:border-white/10">
      <div
        ...
        className="flex cursor-pointer items-center gap-2.5 font-serif text-[1.35rem] font-bold text-indigo dark:text-sand"
      >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="flex h-[38px] w-[38px] items-center justify-center rounded-full bg-sand text-indigo transition-transform hover:-translate-y-0.5 hover:bg-gold dark:text-sand"
        >
        ...
        <button
          ...
          className="relative flex h-[38px] w-[38px] items-center justify-center rounded-full bg-sand text-indigo transition-transform hover:-translate-y-0.5 hover:bg-gold dark:text-sand"
        >
