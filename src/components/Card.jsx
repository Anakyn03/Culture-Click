...
export default function Card({ to, media, tag, title, blurb, footLeft, footRight, saveKey }) {
  ...
  return (
    <div
      ...
      className="group flex cursor-pointer flex-col overflow-hidden rounded-[20px] bg-sand shadow-[0_1px_0_rgba(43,43,43,0.10)] transition-transform duration-300 ease-out hover:-translate-y-1.5 hover:shadow-[0_20px_50px_rgba(31,58,95,0.16)]"
    >
      ...
      <div className="flex flex-1 flex-col px-[18px] pb-5 pt-4">
        <h3 className="font-serif text-[1.15rem] text-indigo dark:text-sand">{title}</h3>
